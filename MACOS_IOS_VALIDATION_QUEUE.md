...
| ID | Date | Evidence |
|---|---|---|
| MAC-IOS-000 | 2026-08-18 | Candidate based on `b1bbf897`; Apple silicon macOS 26.5.2; isolated release app and Keychain identity; fresh login, encrypted-room load, formatted send, relaunch restore, and decrypted marker readback passed; Xcode UI test 1/1 with zero failures. |
