...
| ID | Date | Evidence |
|---|---|---|
| MAC-IOS-001 | 2026-07-07 | Commit `258e2ba`; Xcode 26.5 (17F42); simulator `iPhone 17`, iOS 26.5 (`F31C8CA9-5ACC-4414-8AE1-AE9FA054ECEA`); XcodeBuildMCP `test_sim` with `CODE_SIGNING_ALLOWED=NO CODE_SIGNING_REQUIRED=NO CODE_SIGN_STYLE=Manual DEVELOPMENT_TEAM= -only-testing:SynaraTests/TimelineServiceTests`; passed 35 tests, failed 0; result bundle `/Users/nepenthe/Library/Developer/XcodeBuildMCP/workspaces/synara_project-4f1bff14f6ef/result-bundles/test_sim_2026-07-08T00-56-45-394Z_pid29238_65a5a5a1.xcresult`. |
