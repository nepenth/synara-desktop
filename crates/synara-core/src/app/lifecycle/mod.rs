...
//! and the privacy-safe [`LifecycleError`] domain. Desktop-owned lifecycle
//! modules (logout, recovery, remote_logout, session_material,
//! session_persist, session_restore, wipe, tests) remain in
//! `src-tauri/src/matrix/lifecycle/` because they depend on desktop host
//! stores or `matrix_sdk`.
