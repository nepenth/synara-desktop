...
pub use shared_core_ffi::{
    ...
    PresenceCommandError, PresenceSnapshotDto, PresenceSubscriptionDto, RoomDirectoryHitDto,
    ...
    RoomNotesSnapshotDto, RoomProfileCommandError, RoomProfileWriteDto, SessionAttachDto,
