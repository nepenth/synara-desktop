...
pub use shared_core_ffi::{
    ...
    RoomCreateDto, RoomCreateRequestDto, RoomCreatorsSnapshotDto, RoomDirectoryHitDto,
    ...
    RoomPowerLevelsSnapshotDto, RoomProfileCommandError, RoomProfileWriteDto, SessionAttachDto,
