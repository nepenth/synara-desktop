...
| Desktop validation & release | [`docs/production-smoke-checklist.md`](docs/production-smoke-checklist.md), [`docs/desktop-validation-status.md`](docs/desktop-validation-status.md), [`docs/linux.md`](docs/linux.md) |
