...
| Synapse production operations | [`docs/synapse-production-audit-runbook.md`](docs/synapse-production-audit-runbook.md), [`docs/matrix-production-remediation-handoff.md`](docs/matrix-production-remediation-handoff.md)                                                         |
| Client reliability initiative | [`docs/client-reliability-remediation-plan.md`](docs/client-reliability-remediation-plan.md)                                                                                                                                                     |
