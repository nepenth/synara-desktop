...
const tests = [
  ...
  'src/app/hooks/__tests__/useRoomState.test.ts',
  'src/app/components/app-error/__tests__/errorMessage.test.ts',
  'src/app/hooks/__tests__/useAsyncSearchRenderSafety.test.ts',
  'src/app/hooks/__tests__/useAsyncSearch.test.ts',
  ...
  'src/app/features/approvals/__tests__/nativeAgentApprovalHistory.test.ts',
  ...
  'src/app/pages/client/home/__tests__/homeIdentity.test.ts',
  'src/app/pages/client/inbox/__tests__/notificationResponse.test.ts',
  'src/app/pages/client/inbox/__tests__/nativeInboxNotifications.test.ts',
  'src/app/pages/client/inbox/__tests__/notificationTimeline.test.ts',
  ...
  'src/app/features/matrix-presence/__tests__/nativeUserStatus.test.ts',
  'src/app/features/matrix-rtc/__tests__/nativeRtcTransports.test.ts',
  ...
  'src/app/features/room/__tests__/nativeNotificationObservation.test.ts',
  'src/app/features/room/__tests__/nativePinnedEvents.test.ts',
  ...
  'src/app/features/room/__tests__/nativeTimelineTimestampToEvent.test.ts',
  ...
  'src/app/features/settings/devices/__tests__/nativeX509Identity.test.ts',
  ...
  'src/app/features/widgets/__tests__/experimentalWidgets.test.ts',
