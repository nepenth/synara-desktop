...
const tests = [
  ...
  'src/app/plugins/call/__tests__/nativeCallMediaUploadOwner.test.ts',
  'src/app/plugins/call/__tests__/nativeCallWidgetMediaOwner.test.ts',
  'src/app/plugins/call/__tests__/callWidgetMediaSourceGuard.test.ts',
