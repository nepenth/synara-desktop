...
export const getThreadRootEventId = (event: MatrixEvent | undefined): string | undefined => {
  const relation = event?.getRelation();
  return relation?.rel_type === RelationType.Thread && typeof relation.event_id === 'string'
    ? relation.event_id
    : undefined;
};
