...
export function MText({ edited, content, renderBody, style }: MTextProps) {
...
export function MEmote({ displayName, edited, content, renderBody }: MEmoteProps) {
  const { body, formatted_body: customBody } = content;
...
export function MNotice({ edited, content, renderBody }: MNoticeProps) {
  const { body, formatted_body: customBody } = content;
