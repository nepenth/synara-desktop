...
| `npm run check:release-updater` | Yes | Advisory pass with 4 warnings, 2026-06-29 | Plugin/package/check-only capability wiring, release CI config materialization, signing/artifact handoff, and generated `latest.json` upload are present; committed updater config remains disabled until release-time variables are applied |
