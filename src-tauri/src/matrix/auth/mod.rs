//! P3.1 / P3.2 / P3.3 / R0.7 — Discovery, login-flow, password/token, SSO callback.
//!
...
//!
//! **Out of scope:** UIA (P3.4), session restore (P3.6),
...
pub const MATRIX_AUTH_MARKER: &str = "matrix-auth-sso-callback-p3.3";
...
pub fn matrix_auth_markers() -> &'static str {
    ...
    debug_assert_eq!(MATRIX_AUTH_MARKER, "matrix-auth-sso-callback-p3.3");
    MATRIX_AUTH_MARKER
}
