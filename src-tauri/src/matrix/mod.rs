...
//! P7.7: Native-host Matrix media ownership boundary (service worker forbidden).
...
pub fn matrix_ipc_schema_markers() -> &'static str {
    ...
    let _media_boundary = media_boundary::matrix_media_boundary_markers();
    ...
    debug_assert_eq!(
        _media_boundary,
        media_boundary::MATRIX_MEDIA_BOUNDARY_MARKER
    );
