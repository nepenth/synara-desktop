...
pub fn matrix_ipc_schema_markers() -> &'static str {
    ...
    let _notification_privacy = notification_privacy::matrix_notification_privacy_markers();
    ...
    debug_assert_eq!(
        _notification_privacy,
        notification_privacy::MATRIX_NOTIFICATION_PRIVACY_MARKER
    );
