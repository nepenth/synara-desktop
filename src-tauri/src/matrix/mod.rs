...
//! P9.3: App-focus suppression and badge semantics foundation (pure harness).
...
pub fn matrix_ipc_schema_markers() -> &'static str {
    ...
    let _notification_policy = notification_policy::matrix_notification_policy_markers();
    ...
    debug_assert_eq!(
        ...
        notification_policy::MATRIX_NOTIFICATION_POLICY_MARKER
    );
