...
//! P7.6: Media cache retention / privacy purge policy foundation (metadata only).
...
pub fn matrix_ipc_schema_markers() -> &'static str {
    ...
    let _media_cache_policy = media_cache_policy::matrix_media_cache_policy_markers();
    ...
    debug_assert_eq!(
        _media_cache_policy,
        media_cache_policy::MATRIX_MEDIA_CACHE_POLICY_MARKER
    );
