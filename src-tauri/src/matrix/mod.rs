...
//! P9.4: Room / event / thread notification routing foundation (pure harness).
...
pub fn matrix_ipc_schema_markers() -> &'static str {
    ...
    let _notification_routing = notification_routing::matrix_notification_routing_markers();
    ...
    debug_assert_eq!(
        _notification_routing,
        notification_routing::MATRIX_NOTIFICATION_ROUTING_MARKER
    );
