...
| Message format and safety | ROE-04 | Stay platform-side | in-review | [#1089](https://github.com/nepenth/synara-desktop/pull/1089) | pending | Researcher: stay platform; `formatted_body` comment still misleading |
| Message format and safety | ROE-12 | Shared rules/fixtures | in-review | [#1089](https://github.com/nepenth/synara-desktop/pull/1089) | pending | Cluster memo with ROE-04; fixtures described, not landed |
