...
| Residual engine census | ROE-03 | Extend rows only | in-review | [#1086](https://github.com/nepenth/synara-desktop/pull/1086) | pending | Researcher: close; no missing field |
