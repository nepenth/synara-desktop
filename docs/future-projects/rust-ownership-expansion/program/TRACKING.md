...
| Media metadata | ROE-11 | Metadata only | in-review | [#1090](https://github.com/nepenth/synara-desktop/pull/1090) | pending | Researcher: already owned; unused cache harness is not a second engine |
