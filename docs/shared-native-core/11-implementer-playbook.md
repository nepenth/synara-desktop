...
3. **Is free disk ≥ 20 Gi?** Start the next **P4** slice in section 9.
   ...
   S9-2/#950, and S9-3/#951 landed. S9-4 image packs (section 9.5)
   is on this branch. Next after merge is later account-data.
...
S9-3 join-rule snapshot landed in #951 (`2f43e22c`). **S9-4 (this branch)** adds
