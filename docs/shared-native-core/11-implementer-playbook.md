...
3. **Is free disk ≥ 20 Gi?** Start the next **P4** slice in section 9.
   ...
   S4/#940, S5/#942, and S6/#944 landed. S7 typing/presence
   (section 9.5) is on this branch. Next after merge is S8.
...
S6 landed in #944 (`1a77815a`). **S7 (this branch)** adds typed UniFFI
