...
3. **Is free disk ≥ 20 Gi?** Start the next **P4** slice in section 9.
   ...
   S4/#940, and S5/#942 landed. S6 timeline open/close/paginate
   (section 9.5) is on this branch. Next after merge is S7.
...
S5 landed in #942 (`17c29afd`). **S6 (this branch)** adds typed UniFFI
