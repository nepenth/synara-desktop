...
| Evidence base | `feature/shared-native-core` at `f4fbf42f` (#904, after #903; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers eighty-nine
  desktop-census commands: the prior eighty-eight plus
  `matrix_send_sticker` (#904). Attachment send stays desktop because
  bytes can exceed the 1 MiB Core envelope. The rest of the census remains
...
`f4fbf42f` (#904, after #903). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824, #826, #828, #830, #832, #834, #836, #838, #840, #842, #844, #846, #848, #850, #852, #854, #856, #858, #860, #862, #864, #866, #868, #870, #872, #874, #876, #878, #880, #882, #884, #886, #888, #890, #892, #894, #896, #898, #900, #902, #904 | Eighty-nine-command registry (send_sticker added); full desktop-invoke parity is not reached. |
