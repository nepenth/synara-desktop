...
| Evidence base | `feature/shared-native-core` at `14828f73` (#820, after #819; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers ten
  desktop-census commands: the prior nine plus `matrix_presence_snapshot`
  (#820). The rest of the census remains unregistered and fail-closed.
...
`14828f73` (#820, after #819). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820 | Ten-command registry (`matrix_presence_snapshot` added); full desktop-invoke parity is not reached. |
