...
| Evidence base | `feature/shared-native-core` at `4fb50ac3` (#848, after #847; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers twenty-eight
  desktop-census commands: the prior twenty-seven plus `matrix_verification_cancel`
  (#848). The rest of the census remains unregistered and fail-closed.
...
`4fb50ac3` (#848, after #847). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824, #826, #828, #830, #832, #834, #836, #838, #840, #842, #844, #846, #848 | Twenty-eight-command registry (`matrix_verification_cancel` added); full desktop-invoke parity is not reached. |
