...
| Evidence base | `feature/shared-native-core` at `3937c9f0` (#844, after #843; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers twenty-six
  desktop-census commands: the prior twenty-five plus `matrix_verification_confirm`
  (#844). The rest of the census remains unregistered and fail-closed.
...
`3937c9f0` (#844, after #843). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824, #826, #828, #830, #832, #834, #836, #838, #840, #842, #844 | Twenty-six-command registry (`matrix_verification_confirm` added); full desktop-invoke parity is not reached. |
