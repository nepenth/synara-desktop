...
| Evidence base | `feature/shared-native-core` at `311d7b0a` (#884, after #883; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers sixty-seven
  desktop-census commands: the prior sixty-one plus the six `matrix_later_*`
  commands (#884). The rest of the census remains unregistered and
  fail-closed.
...
`311d7b0a` (#884, after #883). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824, #826, #828, #830, #832, #834, #836, #838, #840, #842, #844, #846, #848, #850, #852, #854, #856, #858, #860, #862, #864, #866, #868, #870, #872, #874, #876, #878, #880, #882, #884 | Sixty-seven-command registry (later account-data commands added); full desktop-invoke parity is not reached. |
