...
| Evidence base | `feature/shared-native-core` at `f00769fd` (#846, after #845; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers twenty-seven
  desktop-census commands: the prior twenty-six plus `matrix_verification_mismatch`
  (#846). The rest of the census remains unregistered and fail-closed.
...
`f00769fd` (#846, after #845). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824, #826, #828, #830, #832, #834, #836, #838, #840, #842, #844, #846 | Twenty-seven-command registry (`matrix_verification_mismatch` added); full desktop-invoke parity is not reached. |
