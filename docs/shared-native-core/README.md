...
| Evidence base | `feature/shared-native-core` at `0c9e9a09` (#902, after #901; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers eighty-eight
  desktop-census commands: the prior eighty-seven plus
  `matrix_edit_message` (#902). The rest of the census remains
...
`0c9e9a09` (#902, after #901). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824, #826, #828, #830, #832, #834, #836, #838, #840, #842, #844, #846, #848, #850, #852, #854, #856, #858, #860, #862, #864, #866, #868, #870, #872, #874, #876, #878, #880, #882, #884, #886, #888, #890, #892, #894, #896, #898, #900, #902 | Eighty-eight-command registry (edit_message added); full desktop-invoke parity is not reached. |
