...
| Evidence base | `feature/shared-native-core` at `b2a19d3f` (#864, after #863; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers thirty-nine
  desktop-census commands: the prior thirty-six plus
  `matrix_timeline_reaction_toggle`, `matrix_reaction_ensure`, and
  `matrix_reaction_redact` (#864). The rest of the census remains
...
`b2a19d3f` (#864, after #863). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824, #826, #828, #830, #832, #834, #836, #838, #840, #842, #844, #846, #848, #850, #852, #854, #856, #858, #860, #862, #864 | Thirty-nine-command registry (timeline reaction mutations added); full desktop-invoke parity is not reached. |
