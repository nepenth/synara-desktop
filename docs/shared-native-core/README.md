...
| Evidence base | `feature/shared-native-core` at `fc08edf7` (#732, after #731; prior bounded P4 evidence remains #708/#710) |
...
`fc08edf7` (#732, after #731). #708 and #710
...
| P1 | #669, #673–#677, #680–#681, #713–#714, #716–#717, #720–#721, #723–#726, #728–#729, #731–#732 | Extraction slices plus backup-flow and cross-signing-identity harnesses; remaining live/SDK domains have not all moved. |
