...
| Evidence base | `feature/shared-native-core` at `0935062a` (#856, after #855; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers thirty-three
  desktop-census commands: the prior thirty-two plus `matrix_timeline_close`
  (#856). The rest of the census remains unregistered and fail-closed.
...
`0935062a` (#856, after #855). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824, #826, #828, #830, #832, #834, #836, #838, #840, #842, #844, #846, #848, #850, #852, #854, #856 | Thirty-three-command registry (`matrix_timeline_close` added); full desktop-invoke parity is not reached. |
