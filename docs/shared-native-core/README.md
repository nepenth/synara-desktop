...
| Evidence base | `feature/shared-native-core` at `7b05a569` (#926, after #925; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  ...
  nine desktop-census commands: the prior one hundred seven plus
  `matrix_invites_accept` and `matrix_invites_decline` (#926). Invite
  spam/block stay desktop because they still mutate membership plus the
  shared handle map.
...
`7b05a569` (#926, after #925). #708 and #710
