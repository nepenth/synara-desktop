...
| Evidence base | `feature/shared-native-core` at `928c0925` (#878, after #877; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers fifty-six
  desktop-census commands: the prior fifty-three plus `matrix_set_room_name`,
  `matrix_set_room_topic`, and `matrix_set_room_avatar` (#878). The rest of
...
`928c0925` (#878, after #877). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824, #826, #828, #830, #832, #834, #836, #838, #840, #842, #844, #846, #848, #850, #852, #854, #856, #858, #860, #862, #864, #866, #868, #870, #872, #874, #876, #878 | Fifty-six-command registry (room name/topic/avatar writes added); full desktop-invoke parity is not reached. |
