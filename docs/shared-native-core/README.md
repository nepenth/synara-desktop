...
| Evidence base | `feature/shared-native-core` at `e197beea` (#810, after #809; prior bounded P4 evidence remains #708/#710) |
...
`e197beea` (#810, after #809). #708 and #710
