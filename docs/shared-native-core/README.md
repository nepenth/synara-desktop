...
| Evidence base | `feature/shared-native-core` at `93c3655b` (#803, after #802; prior bounded P4 evidence remains #708/#710) |
...
`93c3655b` (#803, after #802). #708 and #710
