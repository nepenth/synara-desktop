...
| Evidence base | `feature/shared-native-core` at `db12f31d` (#838, after #837; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers twenty-three
  desktop-census commands: the prior twenty-two plus `matrix_device_rename`
  (#838). The rest of the census remains unregistered and fail-closed.
...
`db12f31d` (#838, after #837). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824, #826, #828, #830, #832, #834, #836, #838 | Twenty-three-command registry (`matrix_device_rename` added); full desktop-invoke parity is not reached. |
