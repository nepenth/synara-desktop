...
| Evidence base | `feature/shared-native-core` at `0df2595e` (#818, after #817; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers nine
  desktop-census commands: the prior eight plus `matrix_typing_snapshot`
  (#818). The rest of the census remains unregistered and fail-closed.
...
`0df2595e` (#818, after #817). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818 | Nine-command registry (`matrix_typing_snapshot` added); full desktop-invoke parity is not reached. |
