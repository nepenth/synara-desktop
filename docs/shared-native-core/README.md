...
| Evidence base | `feature/shared-native-core` at `19a28273` (#900, after #899; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers eighty-seven
  desktop-census commands: the prior eighty-six plus
  `matrix_send_text` (#900). The rest of the census remains
...
`19a28273` (#900, after #899). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824, #826, #828, #830, #832, #834, #836, #838, #840, #842, #844, #846, #848, #850, #852, #854, #856, #858, #860, #862, #864, #866, #868, #870, #872, #874, #876, #878, #880, #882, #884, #886, #888, #890, #892, #894, #896, #898, #900 | Eighty-seven-command registry (send_text added); full desktop-invoke parity is not reached. |
