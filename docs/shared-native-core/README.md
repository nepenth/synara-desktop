...
| Evidence base | `feature/shared-native-core` at `b9b9d2db` (#860, after #859; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers thirty-five
  desktop-census commands: the prior thirty-four plus `matrix_timeline_paginate`
  (#860). The rest of the census remains unregistered and fail-closed.
...
`b9b9d2db` (#860, after #859). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824, #826, #828, #830, #832, #834, #836, #838, #840, #842, #844, #846, #848, #850, #852, #854, #856, #858, #860 | Thirty-five-command registry (`matrix_timeline_paginate` added); full desktop-invoke parity is not reached. |
