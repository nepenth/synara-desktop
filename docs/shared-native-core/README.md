...
| Evidence base | `feature/shared-native-core` at `963f6719` (#854, after #853; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers thirty-two
  desktop-census commands: the prior thirty plus `matrix_device_delete_start`
  and `matrix_device_delete_cancel` (#854). The rest of the census remains
...
`963f6719` (#854, after #853). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824, #826, #828, #830, #832, #834, #836, #838, #840, #842, #844, #846, #848, #850, #852, #854 | Thirty-two-command registry (`matrix_device_delete_start` / `matrix_device_delete_cancel` added); full desktop-invoke parity is not reached. |
