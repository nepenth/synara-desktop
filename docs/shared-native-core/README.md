...
| Evidence base | `feature/shared-native-core` at `13c40365` (#824, after #823; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers twelve
  desktop-census commands: the prior eleven plus `matrix_device_snapshot`
  (#824). The rest of the census remains unregistered and fail-closed.
...
`13c40365` (#824, after #823). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824 | Twelve-command registry (`matrix_device_snapshot` added); full desktop-invoke parity is not reached. |
