...
| Evidence base | `feature/shared-native-core` at `f003d8f7` (#832, after #831; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers nineteen
  desktop-census commands: the prior sixteen plus the three image-pack writes
  (#832). The rest of the census remains unregistered and fail-closed.
...
`f003d8f7` (#832, after #831). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824, #826, #828, #830, #832 | Nineteen-command registry (image-pack writes added); full desktop-invoke parity is not reached. |
