...
| Evidence base | `feature/shared-native-core` at `c040632b` (#805, after #804; prior bounded P4 evidence remains #708/#710) |
...
`c040632b` (#805, after #804). #708 and #710
