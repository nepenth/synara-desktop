...
| Evidence base | `feature/shared-native-core` at `9f12bc38` (#830, after #829; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers sixteen
  desktop-census commands: the prior fourteen plus `matrix_get_user_image_pack`
  and `matrix_get_room_image_packs` (#830). The rest of the census remains
...
`9f12bc38` (#830, after #829). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824, #826, #828, #830 | Sixteen-command registry (`matrix_get_user_image_pack` and `matrix_get_room_image_packs` added); full desktop-invoke parity is not reached. |
