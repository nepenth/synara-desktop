...
| Evidence base | `feature/shared-native-core` at `1f8ba12b` (#842, after #841; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers twenty-five
  desktop-census commands: the prior twenty-four plus `matrix_verification_begin_sas`
  (#842). The rest of the census remains unregistered and fail-closed.
...
`1f8ba12b` (#842, after #841). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824, #826, #828, #830, #832, #834, #836, #838, #840, #842 | Twenty-five-command registry (`matrix_verification_begin_sas` added); full desktop-invoke parity is not reached. |
