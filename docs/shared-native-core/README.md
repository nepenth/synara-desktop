...
| Evidence base | `feature/shared-native-core` at `eec805a1` (#862, after #861; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers thirty-six
  desktop-census commands: the prior thirty-five plus
  `matrix_timeline_set_read_state` (#862). The rest of the census remains
...
`eec805a1` (#862, after #861). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824, #826, #828, #830, #832, #834, #836, #838, #840, #842, #844, #846, #848, #850, #852, #854, #856, #858, #860, #862 | Thirty-six-command registry (`matrix_timeline_set_read_state` added); full desktop-invoke parity is not reached. |
