...
| Evidence base | `feature/shared-native-core` at `aeb5b13e` (#866, after #865; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers forty-one
  desktop-census commands: the prior thirty-nine plus `matrix_timeline_open`
  and `matrix_timeline_jump_latest` (#866). The rest of the census remains
...
`aeb5b13e` (#866, after #865). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824, #826, #828, #830, #832, #834, #836, #838, #840, #842, #844, #846, #848, #850, #852, #854, #856, #858, #860, #862, #864, #866 | Forty-one-command registry (`matrix_timeline_open` / `matrix_timeline_jump_latest` added); full desktop-invoke parity is not reached. |
