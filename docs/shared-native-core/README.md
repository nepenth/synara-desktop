...
| Evidence base | `feature/shared-native-core` at `9bf4aa2c` (#852, after #851; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers thirty
  desktop-census commands: the prior twenty-nine plus `matrix_verification_start`
  (#852). The rest of the census remains unregistered and fail-closed.
...
`9bf4aa2c` (#852, after #851). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824, #826, #828, #830, #832, #834, #836, #838, #840, #842, #844, #846, #848, #850, #852 | Thirty-command registry (`matrix_verification_start` added); full desktop-invoke parity is not reached. |
