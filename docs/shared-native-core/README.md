...
| Evidence base | `feature/shared-native-core` at `faf5f28c` (#840, after #839; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers twenty-four
  desktop-census commands: the prior twenty-three plus `matrix_verification_accept`
  (#840). The rest of the census remains unregistered and fail-closed.
...
`faf5f28c` (#840, after #839). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824, #826, #828, #830, #832, #834, #836, #838, #840 | Twenty-four-command registry (`matrix_verification_accept` added); full desktop-invoke parity is not reached. |
