...
| Evidence base | `feature/shared-native-core` at `44c674ce` (#880, after #879; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers fifty-eight
  desktop-census commands: the prior fifty-six plus
  `matrix_get_room_directory_visibility` and
  `matrix_set_room_directory_visibility` (#880). The rest of the census
  remains unregistered and fail-closed.
...
`44c674ce` (#880, after #879). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824, #826, #828, #830, #832, #834, #836, #838, #840, #842, #844, #846, #848, #850, #852, #854, #856, #858, #860, #862, #864, #866, #868, #870, #872, #874, #876, #878, #880 | Fifty-eight-command registry (directory visibility get/set added); full desktop-invoke parity is not reached. |
