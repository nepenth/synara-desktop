...
| Evidence base | `feature/shared-native-core` at `00116f01` (#910, after #909; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers ninety-nine
  desktop-census commands: the prior ninety-seven plus own display-name and
  avatar writes (#910). Attachment send stays desktop because bytes can
...
`00116f01` (#910, after #909). #708 and #710
