...
| Evidence base | `feature/shared-native-core` at `abaf750a` (#886, after #885; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers seventy-two
  desktop-census commands: the prior sixty-seven plus the five
  `matrix_room_notes_*` commands (#886). The rest of the census remains
...
`abaf750a` (#886, after #885). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824, #826, #828, #830, #832, #834, #836, #838, #840, #842, #844, #846, #848, #850, #852, #854, #856, #858, #860, #862, #864, #866, #868, #870, #872, #874, #876, #878, #880, #882, #884, #886 | Seventy-two-command registry (room-notes account-data commands added); full desktop-invoke parity is not reached. |
