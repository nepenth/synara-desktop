...
| Evidence base | `feature/shared-native-core` at `c45ad6ae` (#822, after #821; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers eleven
  desktop-census commands: the prior ten plus `matrix_verification_list`
  (#822). The rest of the census remains unregistered and fail-closed.
...
`c45ad6ae` (#822, after #821). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822 | Eleven-command registry (`matrix_verification_list` added); full desktop-invoke parity is not reached. |
