...
| Evidence base | `feature/shared-native-core` at `7315ffe6` (#908, after #907; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers ninety-seven
  desktop-census commands: the prior ninety-one plus the six space snapshot
  and write routes (#908). Attachment send stays desktop because bytes can
...
`7315ffe6` (#908, after #907). #708 and #710
