...
| Evidence base | `feature/shared-native-core` at `cf04eae0` (#858, after #857; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers thirty-four
  desktop-census commands: the prior thirty-three plus
  `matrix_timeline_event_readback` (#858). The rest of the census remains
...
`cf04eae0` (#858, after #857). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824, #826, #828, #830, #832, #834, #836, #838, #840, #842, #844, #846, #848, #850, #852, #854, #856, #858 | Thirty-four-command registry (`matrix_timeline_event_readback` added); full desktop-invoke parity is not reached. |
