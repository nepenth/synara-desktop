...
| Evidence base | `feature/shared-native-core` at `fecf19cd` (#874, after #873; prior bounded P4 evidence remains #708/#710) |
...
- **P2 is a partial transport registry, not the complete command migration.**
  `Core::command` has typed envelopes and currently registers fifty
  desktop-census commands: the prior forty-eight plus
  `matrix_timeline_forward_text` and `matrix_timeline_forward_media` (#874).
...
`fecf19cd` (#874, after #873). #708 and #710
...
| P2 | #683–#689, #694, #698, #701–#702, #706, #818, #820, #822, #824, #826, #828, #830, #832, #834, #836, #838, #840, #842, #844, #846, #848, #850, #852, #854, #856, #858, #860, #862, #864, #866, #868, #870, #872, #874 | Fifty-command registry (`matrix_timeline_forward_text` / `matrix_timeline_forward_media` added); full desktop-invoke parity is not reached. |
