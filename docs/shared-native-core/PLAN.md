...
- **P2 — in progress; transport registry is intentionally partial.** #683–#684
  ...
  Later 7B slices through #916 grow that registry to one hundred three names,
  including directory search/cancel. Neither #708, #710, #713,
