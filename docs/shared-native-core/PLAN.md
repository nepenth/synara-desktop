...
- **P2 — in progress; transport registry is intentionally partial.** #683–#684
  ...
  Later 7B slices through #910 grow that registry to ninety-nine names,
  including own display-name and avatar writes. Neither #708, #710, #713,
