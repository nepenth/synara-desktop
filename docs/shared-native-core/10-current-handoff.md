...
| Item | Verified state |
|---|---|
| Feature evidence tip | `feature/shared-native-core` is `00116f01`, the merge commit for #910. |
| Immediately preceding merges | #909 docs after #908, #910 own display-name / avatar writes. |
...
anchor, but it is no longer the feature-tip provenance; use `00116f01`/#910 for
...
### P2 — in progress: ninety-nine registered commands

The Core registry registers exactly these ninety-nine names:
