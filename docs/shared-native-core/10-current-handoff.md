...
| Item | Verified state |
|---|---|
| Feature evidence tip | `feature/shared-native-core` is `abaf750a`, the merge commit for #886. |
| Immediately preceding merges | #885 docs after #884, #886 room-notes account-data commands. |
...
anchor, but it is no longer the feature-tip provenance; use `abaf750a`/#886 for
...
### P2 — in progress: seventy-two registered commands

The Core registry registers exactly these seventy-two names:
