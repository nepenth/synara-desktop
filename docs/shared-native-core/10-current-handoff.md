...
| Item | Verified state |
|---|---|
| Feature evidence tip | `feature/shared-native-core` is `10bc7441`, the merge commit for #868. |
| Immediately preceding merges | #867 docs after #866, #868 timeline edit/redact. |
...
anchor, but it is no longer the feature-tip provenance; use `10bc7441`/#868 for
...
### P2 — in progress: forty-three registered commands

The Core registry registers exactly these forty-three names:
