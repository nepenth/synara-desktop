...
| Item | Verified state |
|---|---|
| Feature evidence tip | `feature/shared-native-core` is `eec805a1`, the merge commit for #862. |
| Immediately preceding merges | #861 docs after #860, #862 `matrix_timeline_set_read_state`. |
...
anchor, but it is no longer the feature-tip provenance; use `eec805a1`/#862 for
...
### P2 — in progress: thirty-six registered commands

The Core registry registers exactly these thirty-six names:
