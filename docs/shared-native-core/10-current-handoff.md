...
3. P4-S3 plan is `12-p4-s3-live-client.md`. S3a landed in #935. Next
   is **S3b** restore (no password). UniFFI expansion still needs free
   disk ≥ 20 Gi for local cargo/bindgen.
