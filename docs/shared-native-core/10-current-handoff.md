...
| Item | Verified state |
|---|---|
| Feature evidence tip | `feature/shared-native-core` is `1f8ba12b`, the merge commit for #842. |
| Immediately preceding merges | #841 docs after #840, #842 `matrix_verification_begin_sas` through Core::command. |
...
anchor, but it is no longer the feature-tip provenance; use `1f8ba12b`/#842 for
...
### P2 — in progress: twenty-five registered commands

The Core registry registers exactly these twenty-five names:
