...
| Item | Verified state |
|---|---|
| Feature evidence tip | `feature/shared-native-core` is `0c9e9a09`, the merge commit for #902. |
| Immediately preceding merges | #901 docs after #900, #902 edit_message. |
...
anchor, but it is no longer the feature-tip provenance; use `0c9e9a09`/#902 for
...
### P2 — in progress: eighty-eight registered commands

The Core registry registers exactly these eighty-eight names:
