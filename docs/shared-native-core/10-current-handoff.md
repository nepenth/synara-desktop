...
| Item | Verified state |
|---|---|
| Feature evidence tip | `feature/shared-native-core` is `79aacab4`, the merge commit for #918. |
| Immediately preceding merges | #917 docs after #916, #918 room-key transfer status. |
...
| #868 / `10bc7441` | timeline edit/redact via `Core::command` | Same attached timeline owner. |
| #870 / `d125c7ad` | timeline report/pin/unpin via `Core::command` | Same attached timeline owner. |
| #872 / `53f49a20` | timeline poll-vote/call-decline via `Core::command` | Same attached timeline owner. |
...
| #882 / `494f2646` | m.direct snapshot/add/remove via `Core::command` | Image-pack owner now owns m.direct. |
| #884 / `311d7b0a` | later account-data via `Core::command` | Same attached account-data owner. |
...
| #894 / `484e5b0f` | bulk power-level writes via `Core::command` | Same attached room-profile owner. |
| #896 / `3b844c4c` | room create via `Core::command` | Same attached room-profile owner. |
| #898 / `72125ba0` | members snapshots via `Core::command` | Same attached room-profile owner. |
...
| #910 / `00116f01` | own display-name / avatar writes via `Core::command` | Image-pack owner now owns those account profile writes. |
| #912 / `00e90a2f` | backup status via `Core::command` | Device owner now owns live backup status. Setup/restore/repair stay desktop. |
| #914 / `b72a2f9a` | directory protocols via `Core::command` | Join-rule owner now owns protocol listing. Search/cancel later moved in #916. |
...
anchor, but it is no longer the feature-tip provenance; use `79aacab4`/#918 for
...
### P2 — in progress: one hundred four registered commands

The Core registry registers exactly these one hundred four names:
...
42. `matrix_timeline_edit_text` (#868)
43. `matrix_timeline_redact` (#868)
44. `matrix_timeline_report` (#870)
45. `matrix_timeline_pin` (#870)
46. `matrix_timeline_unpin` (#870)
47. `matrix_timeline_poll_vote` (#872)
48. `matrix_timeline_call_decline` (#872)
49. `matrix_timeline_forward_text` (#874)
50. `matrix_timeline_forward_media` (#874)
51. `matrix_composer_set_reply_draft` (#876)
52. `matrix_composer_clear_reply_draft` (#876)
53. `matrix_composer_get_reply_draft` (#876)
...
59. `matrix_mdirect_snapshot` (#882)
60. `matrix_mdirect_add` (#882)
61. `matrix_mdirect_remove` (#882)
62. `matrix_later_snapshot` (#884)
63. `matrix_later_upsert` (#884)
64. `matrix_later_complete` (#884)
65. `matrix_later_snooze` (#884)
66. `matrix_later_clear_completed` (#884)
67. `matrix_later_mark_reminded` (#884)
68. `matrix_room_notes_snapshot` (#886)
69. `matrix_room_notes_upsert` (#886)
70. `matrix_room_notes_delete` (#886)
71. `matrix_room_notes_complete_todo` (#886)
72. `matrix_room_notes_move_todo` (#886)
73. `matrix_room_leave` (#888)
74. `matrix_room_join` (#888)
75. `matrix_room_invite` (#890)
76. `matrix_room_kick` (#890)
77. `matrix_room_ban` (#890)
78. `matrix_room_unban` (#890)
79. `matrix_room_set_power_level` (#892)
80. `matrix_room_set_power_levels` (#894)
81. `matrix_room_set_power_level_tags` (#894)
82. `matrix_room_create` (#896)
83. `matrix_room_members_snapshot` (#898)
84. `matrix_room_power_levels_snapshot` (#898)
85. `matrix_room_creators_snapshot` (#898)
86. `matrix_room_power_level_tags_snapshot` (#898)
...
98. `matrix_set_own_display_name` (#910)
99. `matrix_set_own_avatar` (#910)
100. `matrix_backup_status` (#912)
101. `matrix_room_directory_protocols` (#914)
102. `matrix_room_directory_search` (#916)
103. `matrix_room_directory_cancel` (#916)
104. `matrix_room_key_transfer_status` (#918)

All other census command names remain unregistered and fail closed. `matrix_send_attachment` stays desktop because attachment bytes can exceed the 1 MiB Core envelope. Backup setup/restore/repair and room-key export/import stay desktop so secrets never cross the envelope. This is
