...
| Item | Verified state |
|---|---|
| Feature evidence tip | `feature/shared-native-core` is `c2282aa2`, the merge commit for #876. |
| Immediately preceding merges | #875 docs after #874, #876 composer reply-draft trio. |
...
anchor, but it is no longer the feature-tip provenance; use `c2282aa2`/#876 for
...
### P2 — in progress: fifty-three registered commands

The Core registry registers exactly these fifty-three names:
