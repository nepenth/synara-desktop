...
and 199 under `crates/synara-core/src/app/`; the difference reflects P1 moves,
...
later/room-notes codecs, image-pack DTO/type-filters/write-guards, and m.direct snapshot helpers.
