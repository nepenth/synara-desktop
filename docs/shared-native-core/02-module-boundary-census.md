...
current evidence tip, there are 124 tracked Rust files under that desktop path
and 173 under `crates/synara-core/src/app/`; the difference reflects P1 moves,
...
queue, room-keys transfer flow, supervisor actor, and diagnostics health.
