...
At `feature/shared-native-core` `b9b9d2db`
(#860, after #859), P2 registers thirty-five names—the prior thirty-four plus
`matrix_timeline_paginate`. The previous thirty-four remain—
