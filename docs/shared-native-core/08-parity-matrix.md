...
At `feature/shared-native-core` `0c9e9a09`
(#902, after #901), P2 registers eighty-eight names—the prior eighty-seven plus
`matrix_edit_message`. The previous eighty-seven remain—
