...
At `feature/shared-native-core` `b3ed8891`
(#922, after #921), P2 registers one hundred six names—the prior one hundred
five plus `matrix_room_list_snapshot`. The previous one hundred five remain—
