...
At `feature/shared-native-core` `f4fbf42f`
(#904, after #903), P2 registers eighty-nine names—the prior eighty-eight plus
`matrix_send_sticker`. The previous eighty-eight remain—
