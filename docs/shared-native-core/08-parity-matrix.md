...
At `feature/shared-native-core` `484e5b0f`
(#894, after #893), P2 registers eighty-one names—the prior seventy-nine plus
bulk power-level writes. The previous seventy-nine remain—
