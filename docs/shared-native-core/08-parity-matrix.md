...
At `feature/shared-native-core` `82134fca`
(#920, after #919), P2 registers one hundred five names—the prior one hundred
four plus `matrix_cross_signing_setup`. The previous one hundred four remain—
