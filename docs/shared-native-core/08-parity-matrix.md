...
At `feature/shared-native-core` `c9a315ea`
(#916, after #915), P2 registers one hundred three names—the prior one hundred
one plus directory search/cancel. The previous one hundred one remain—
