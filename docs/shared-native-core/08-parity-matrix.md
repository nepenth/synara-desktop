...
At `feature/shared-native-core` `00e90a2f`
(#912, after #911), P2 registers one hundred names—the prior ninety-nine plus
`matrix_backup_status`. The previous ninety-nine remain—
