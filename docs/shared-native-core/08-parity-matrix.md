...
At `feature/shared-native-core` `cf04eae0`
(#858, after #857), P2 registers thirty-four names—the prior thirty-three plus
`matrix_timeline_event_readback`. The previous thirty-three remain—
