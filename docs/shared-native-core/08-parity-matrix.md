...
At `feature/shared-native-core` `311d7b0a`
(#884, after #883), P2 registers sixty-seven names—the prior sixty-one plus
the six `matrix_later_*` commands. The previous sixty-one remain—
