...
At `feature/shared-native-core` `53f49a20`
(#872, after #871), P2 registers forty-eight names—the prior forty-six plus
`matrix_timeline_poll_vote` and `matrix_timeline_call_decline`. The previous
forty-six remain—
