...
At `feature/shared-native-core` `76b3a80d`
(#924, after #923), P2 registers one hundred seven names—the prior one hundred
six plus `matrix_invites_snapshot`. The previous one hundred six remain—
