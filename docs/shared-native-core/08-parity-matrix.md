...
At `feature/shared-native-core` `f00769fd`
(#846, after #845), P2 registers twenty-seven names—the prior twenty-six plus
`matrix_verification_mismatch`. The previous twenty-six remain—
...
`matrix_verification_accept`, `matrix_verification_begin_sas`, and
`matrix_verification_confirm`—and all
