...
At `feature/shared-native-core` `b72a2f9a`
(#914, after #913), P2 registers one hundred one names—the prior one hundred
plus `matrix_room_directory_protocols`. The previous one hundred remain—
