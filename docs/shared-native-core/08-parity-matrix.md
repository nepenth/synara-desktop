...
At `feature/shared-native-core` `19a28273`
(#900, after #899), P2 registers eighty-seven names—the prior eighty-six plus
`matrix_send_text`. The previous eighty-six remain—
