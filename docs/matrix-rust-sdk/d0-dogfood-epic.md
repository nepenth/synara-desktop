...
1. **Close residual queue** in [d0-residual-completion.md](d0-residual-completion.md) — V-CRYPTO.1–.6 are done; monitor and land V-CRYPTO.7 [#236](https://github.com/nepenth/synara-desktop/pull/236), then continue with V-AUTH.1.
