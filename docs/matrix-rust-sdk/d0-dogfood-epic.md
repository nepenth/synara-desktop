...
1. **Close residual queue** in [d0-residual-completion.md](d0-residual-completion.md) — V-CRYPTO.1–.6 are done; review the V-CRYPTO.7 candidate, then continue with V-AUTH.1.
