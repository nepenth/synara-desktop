...
| Field                        | Current value                                                                                                                                                                                                                                                                      |
| ---------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Integration branch / tip** | `feature/matrix-rust-sdk-full-replacement` @ `88ed14308227b2eec2bed4fc33d97cfa0a2270f3`; V-SEND.3 [#250](https://github.com/nepenth/synara-desktop/pull/250) merged after V-ROOMS.5r [#252](https://github.com/nepenth/synara-desktop/pull/252) at `9579ea4`                        |
| **Policy**                   | [Full vertical replacement](full-vertical-policy.md): no minima/plateau; **physical deletion per vertical**                                                                                                                                                                        |
| **Active product work**      | Serial: V-SEND.4 [#253](https://github.com/nepenth/synara-desktop/pull/253) → V-ROOMS.2b [#254](https://github.com/nepenth/synara-desktop/pull/254) → continue V-TIMELINE [#240](https://github.com/nepenth/synara-desktop/pull/240) **HOLD**.                                     |
| **Completed verticals**      | D0 core #214/#216/#218/#219/#220; V-CRYPTO.1–.7; V-AUTH.1; V-ROOMS.1/.3/.4/.2a/.5/.5w/.5r; V-SEND.1/.2/.3                                                                                                                                                                            |
| **Deletion residuals**       | V-SEND.4 composer fallback on #253; V-ROOMS.2b hierarchy JS on #254; V-TIMELINE JS shell until #240 closable; later auth/rooms/send/media gaps per residual queue                                                                                                                   |
| **Next product work**        | Finish #253 CI→merge; rebase/fix/merge #254; close #240 contract gaps only when complete — no presenter/`RoomTimeline` deletion early; do not start new media/widgets/notifications/calls until residual queue allows                                                              |
...
| **Usage**                    | GPT-5.6 sol/terra API credits exhausted; Cursor plan ~97% — prefer Cursor/local; keep serial                                                                                                                                                                                       |
...
| **Durable handoff**          | [SESSION-HANDOFF.md](SESSION-HANDOFF.md)                                                                                                                                                                                                                                           |

### Current next-owner procedure

1. Treat tip `88ed143` as current after V-SEND.3 [#250](https://github.com/nepenth/synara-desktop/pull/250) (tip may move when #253 merges).
2. Finish V-SEND.4 [#253](https://github.com/nepenth/synara-desktop/pull/253): wait for Validate/Quality (+ rich-message/attachment proofs) on exact head `486b3d7` or later, undraft, `gh pr merge --merge` to integration only. Do not fight the #253 worktree if another agent owns it.
3. Rebase/fix V-ROOMS.2b [#254](https://github.com/nepenth/synara-desktop/pull/254) onto the new tip (currently dirty vs `88ed143`); required CI green; undraft; merge.
4. Continue V-TIMELINE [#240](https://github.com/nepenth/synara-desktop/pull/240) contract gaps until closable — no presenter selection or `RoomTimeline.tsx` deletion until contract + runtime proof.
5. Do **not** merge #221, L1 foundation PRs, or umbrella #39 without explicit policy/user approval.
6. Update [PROGRESS.md](PROGRESS.md), [d0-residual-completion.md](d0-residual-completion.md), [CONTINUATION.md](CONTINUATION.md), and [SESSION-HANDOFF.md](SESSION-HANDOFF.md) whenever tip/active/open disposition changes.
