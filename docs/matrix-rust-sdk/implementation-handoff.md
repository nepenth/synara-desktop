...
| Field | Current value |
|---|---|
| **Integration branch / tip** | `feature/matrix-rust-sdk-full-replacement` @ `9ab482bcc00998b3c9f62d227ccacfd42000b6cd` (PR #86 / R0.5 merge) |
| **Dual-track strategy** | Land Critical/High product fixes first; timebox R0.2-E1 CI; do not block product work on R0.8 theater |
| **R0.5 / REV-001** | **Merged and accepted** via PR [#86](https://github.com/nepenth/synara-desktop/pull/86) — wipe drops client + retires tasks before store delete; vault fail retains store |
| **Active remediation** | R0.4 — `in_progress`, PR [#87](https://github.com/nepenth/synara-desktop/pull/87) open (store confinement) |
| **Also open** | R0.2-E1 PR [#82](https://github.com/nepenth/synara-desktop/pull/82) — tooling landed as artifact; merge only if green; park residual if thrash |
| **Next product slice** | Independent review/merge of #87 if green; then R0.6 diagnostic privacy |
