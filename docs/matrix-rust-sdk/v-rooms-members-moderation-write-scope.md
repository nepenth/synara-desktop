...
| ID                          | Residual                                                                                    | Notes                                                                                                                                        |
| --------------------------- | ------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| **V-ROOMS.R-MEMBERS-READ**  | #395/#405 own native member enumeration; #439 owns the separate bulk power/tag WRITE; **#450 merged** native power-level/creator READ owners. Custom power-level-tag READ plus direct helper/plugin readers remain residual; #458's presence first slice does not change this boundary. | See [members-read residual inventory](v-rooms-members-read-residual.md); #450 closes the migrated power/creator paths, not the tag/direct-reader boundary |
| **V-ROOMS.R-POWERS-BULK**   | **#439 merged** — PowersEditor / PermissionGroups bulk `m.room.power_levels` and `in.synara.room.power_level_tags` writes | Separate WRITE slice; #450 separately provides native power-level/creator READ snapshots; custom tag READ remains open; #461's first directory slice is merged and does not alter this residual |
