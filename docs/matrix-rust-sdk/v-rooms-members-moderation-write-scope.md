...
| **V-ROOMS.R-POWERS-BULK**   | **#439 merged** — PowersEditor / PermissionGroups bulk `m.room.power_levels` and `in.synara.room.power_level_tags` writes | Separate WRITE slice; #450 separately provides native power-level/creator READ snapshots; custom tag READ remains open; hold merge while #461 is hot |
