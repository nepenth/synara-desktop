...
| ID                          | Residual                                                                                    | Notes                                                                                                                                        |
| --------------------------- | ------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| **V-ROOMS.R-MEMBERS-READ**  | #395/#405 own native member enumeration; #439 owns the separate bulk power/tag WRITE; #446 only changes command layout. **#450** power-level/creator READ remains residual and is in flight. | See [members-read residual inventory](v-rooms-members-read-residual.md); do not treat #405, #439, or #446 as a power-read implementation; #450 is not merged |
