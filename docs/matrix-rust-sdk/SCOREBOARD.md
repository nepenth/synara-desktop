...
| ------------------------------------------------------ | -------------------------------------------------------- |
| Updated                                                | 2026-08-02                                               |
| Tip                                                    | `d82e043d` on `feature/matrix-rust-sdk-full-replacement`; #439 powers-bulk, #446 product-command fan-out, #450 native power/creator READs, and #458's native presence first slice are merged |
