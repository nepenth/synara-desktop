...
| ------------------------------------------------------ | -------------------------------------------------------- |
| Updated                                                | 2026-08-02                                               |
| Tip                                                    | `103a653f` on `feature/matrix-rust-sdk-full-replacement`; #439 powers-bulk, #446 product-command fan-out, and #450 native power/creator READs are merged |
...
| Presence product vertical        | **Open #458 / WIP** — parallel module-scoped implementation remains open; JS-owner deletion, focused proof, live proof, and acceptance remain open |
| Room directory product vertical  | **Open #461 / WIP** — parallel module-scoped implementation remains open; JS-owner deletion, focused proof, live proof, and acceptance remain open |
...
| ----- | ----------------- |
| [Presence](v-presence-implement-packet.md) | **Open #458 / WIP in parallel**; module-owned; no shared `product.rs` ownership required; not product-done |
| [Room directory](v-rooms-directory-implement-packet.md) | **Open #461 / WIP in parallel**; module-owned; no shared `product.rs` ownership required; not product-done |
...
1. **Presence #458 + room directory #461 — still open.** **#450**
   power/creator READs are merged, but neither of these product verticals is
   complete. Native wiring, superseded JS-owner deletion, focused evidence,
   live proof, and acceptance remain open; do not treat packet extraction as
