...
|-------|-------|
| Updated | 2026-08-01 |
| Tip | `1e318d71` on `feature/matrix-rust-sdk-full-replacement` |
...
- ~~**V-SEND.R-CALL-UPLOAD**~~ **#328**; ~~**V-SEND.R-GIF-PACK**~~ **NOOP** ([audit](v-send-gif-pack-audit.md)); composer/thumbnail legacy-web fallbacks — [upload call-site audit](v-send-upload-residual-audit.md); **#325** open hardens msgContent thumbnails
