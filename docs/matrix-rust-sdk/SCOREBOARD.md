...
| ------------------------------------------------------ | -------------------------------------------------------- |
| Updated                                                | 2026-08-01                                               |
| Tip                                                    | `3a71f482` on `feature/matrix-rust-sdk-full-replacement` |
...
1. **V-SEND.R-PACK-READ** — delete the JS `get*` helpers in
   `custom-emoji/utils.ts` when the non-native web fallback is retired
   (**V-BURN-gated**); keep `packAddressEqual`, `imageUsageEqual`, and
   `packMetaEqual`.
2. **V-TIMELINE.C3–C5** — live proofs remain **Not confirmed**; the operator
