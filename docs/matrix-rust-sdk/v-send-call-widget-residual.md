...
| Tip      | `103a653f` on `feature/matrix-rust-sdk-full-replacement`                                                                |
...
> **Tip honesty.** This docs-only refresh is measured at `103a653f`, a later
> integration tip carrying #450 power/creator reads. The CallWidget
> implementation paths and focused evidence are unchanged from the prior
> #407-containing tip `206d24f3`; this update changes the evidence anchor only.
...
The scan and source anchors above were revalidated at tip `103a653f`. No
CallWidget implementation path changed between that tip and the prior
`206d24f3` evidence anchor.
