...
| **V-ROOMS.5** | `m.direct` DM room-id map            | **Draft candidate** — native `matrix_mdirect_snapshot` owns `mDirectAtom`; JS AccountData binder deleted; production **189→188**, repository-wide **202→201**; writers residual; live proof unclaimed      | Native DM map; JS mDirect binder deleted                                            |
