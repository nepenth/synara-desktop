...
| Field                     | Value                                                                                                                                                                                         |
| ------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Status                    | **Active — tip `00fb7788` after #270 docs; open #268 V-ROOMS.2c, #266 V-AUTH.4b, #240 HOLD** (2026-07-31) |
...
| **V-ROOMS.2c** | Local graph + mutations/reordering | **Active** full [#268](https://github.com/nepenth/synara-desktop/pull/268); partial writers [#267](https://github.com/nepenth/synara-desktop/pull/267) closed/superseded | Native graph/readback and mutation commands; delete superseded JS owners |
