...
| **V-SEND.3** | Polls                                   | **In flight** [#250](https://github.com/nepenth/synara-desktop/pull/250) at `501242c` (poll proof Confirmed; rebase onto `0fb0fe4` then merge when Validate/Quality green)                                                                                                           | Native                                                  |
