...
| ID               | Capability                               | Residual today                                                                                                                                                                                                                                                                                                                                                                                   | Done when                                                                                       |
| ---------------- | ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------- |
| **V-TIMELINE.1** | Virtualized timeline on native DTOs      | **Cutover approved** [#240](https://github.com/nepenth/synara-desktop/pull/240): tip-merge + inventory baseline refresh, then select `NativeTimelinePresenter` and delete `RoomTimeline` / js owners under full-vertical sole-owner rules. Native DTO shell + action gates exist; residual parity (media/stream/pins) closes in cutover slices. Client breakage during cutover is acceptable — fix forward. | Native presenter is sole product path; JS `RoomTimeline` deleted; import allowlist declines; no dual_backend |
