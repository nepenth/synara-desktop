...
| Field                     | Value                                                                                                                                                                                         |
| ------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Status                    | **Active — tip `9c0b51e` after #254; open #258 V-SEND.5 / #262 V-AUTH.2 / #263 V-AUTH.4a; #240 HOLD; #261 merged** (2026-07-31)                                                                                       |
| Policy                    | [full-vertical-policy.md](full-vertical-policy.md)                                                                                                                                            |
| Integration tip at policy | `0400306` (D0.1–D0.5 merged; D0.5 was **crypto minimum**)                                                                                                                                     |
| Current integration tip   | `9c0b51e4d0706e7ad6cafe82172e3c9e8406fcea` ([#254](https://github.com/nepenth/synara-desktop/pull/254) V-ROOMS.2b after #260/#256/#253)                                                                                                              |
| Active PRs                | Draft [#258](https://github.com/nepenth/synara-desktop/pull/258) V-SEND.5; [#262](https://github.com/nepenth/synara-desktop/pull/262) V-AUTH.2; [#263](https://github.com/nepenth/synara-desktop/pull/263) V-AUTH.4a; [#240](https://github.com/nepenth/synara-desktop/pull/240) V-TIMELINE HOLD; ready [#261](https://github.com/nepenth/synara-desktop/pull/261) docs |
...
| **V-AUTH.2** | Token login                    | **Active draft** [#262](https://github.com/nepenth/synara-desktop/pull/262) — product **non-retention** close (not re-home); JS `TokenLogin` already gone via V-AUTH.1 | Explicit product decision: desktop does not retain `m.login.token`; remove unused Rust token-login foundation; discovery-only of HS-advertised method remains                                                                                                              |
...
| **V-AUTH.4** | Register / reset-password      | Split: **4a active** [#263](https://github.com/nepenth/synara-desktop/pull/263) password reset; **4b residual** registration still js | Re-home retained desktop auth surfaces; 4a owns password-reset email token + UIAA complete; 4b register remains residual                                                                                                                                                  |
...
| **V-SEND.5** | Threads                                 | **Active draft** [#258](https://github.com/nepenth/synara-desktop/pull/258) — tip-merged after #254; re-CI then merge when green; stickers/GIF/poll-in-thread/thread UI remain residual                                                                                     | Native thread send/relations                            |
...
2. Serial after tip `9c0b51e`: **V-SEND.5** [#258] (tip-merged after #254; re-CI) → docs [#261] when green → auth closes **V-AUTH.2** [#262] / **V-AUTH.4a** [#263] as CI allows. V-ROOMS.2b #254 merged.
