...
| Field                     | Value                                                                                                                                                                     |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Status                    | **Active — V-SEND.1 #248 merged; V-ROOMS.5 m.direct #249 draft; V-TIMELINE #240 parallel ownership** (2026-07-30)                                              |
| Policy                    | [full-vertical-policy.md](full-vertical-policy.md)                                                                                                                        |
| Integration tip at policy | `0400306` (D0.1–D0.5 merged; D0.5 was **crypto minimum**)                                                                                                                 |
| Current integration tip   | `90be0f4ef6efb3915bb886790ebc94e39f088092` (V-SEND.1 #248 merge)                                                                                                           |
| Active PRs                | Draft V-ROOMS.5 m.direct [#249](https://github.com/nepenth/synara-desktop/pull/249); [#240](https://github.com/nepenth/synara-desktop/pull/240) V-TIMELINE |
...
| **V-ROOMS.5** | `m.direct` DM room-id map            | **Draft candidate** — native `matrix_mdirect_snapshot` owns `mDirectAtom`; JS AccountData binder + unused `useBindAtoms` MatrixClient import deleted; production **189→187**, repository-wide **202→200**; writers residual; live proof unclaimed | Native DM map; JS mDirect binder deleted                                            |
