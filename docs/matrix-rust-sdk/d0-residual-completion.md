...
| Field                     | Value                                                                                                                                                                                         |
| ------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Status                    | **Active — tip `a677a80` after #265/#263; #264 sticker/GIF; #240 HOLD; residual V-AUTH.4b / V-ROOMS.2c** (2026-07-31) |
| Policy                    | [full-vertical-policy.md](full-vertical-policy.md)                                                                                                                                            |
| Integration tip at policy | `0400306` (D0.1–D0.5 merged; D0.5 was **crypto minimum**)                                                                                                                                     |
| Current integration tip   | `a677a80` ([#265](https://github.com/nepenth/synara-desktop/pull/265) docs after #263 V-AUTH.4a) |
| Active PRs                | Sticker/GIF draft (this); V-AUTH.4b WIP; [#240](https://github.com/nepenth/synara-desktop/pull/240) HOLD |
...
| ID           | Capability                              | Residual today                                                                                                                                                                                                                                                                         | Done when                                               |
| ------------ | --------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| **V-SEND.1** | Attachments / media upload send         | **DONE #248** at integration `90be0f4`; Synapse native attachment proof Confirmed; avatar/call/forward residual remain elsewhere; sticker/GIF native send is **V-SEND sticker/GIF residual** (this slice)                                                                                      | Native send queue + IPC + JS owner deletion             |
...
| **V-SEND.5** | Threads                                 | **DONE #258** at `5c6e6e8`; native composer text/attachment `m.thread` via `threadRoot`; Synapse thread-send proof Confirmed; sticker/GIF native send residual opened as active slice (poll-in-thread + thread list/timeline remain elsewhere) | Native thread send/relations                            |
| **V-SEND sticker/GIF** | Composer sticker + GIF send | **Active draft** [#264](https://github.com/nepenth/synara-desktop/pull/264) — native `matrix_send_sticker` + GIF via `matrix_send_attachment`; RoomInput fail-closed on native session; pack settings / media display residual remain | Native m.sticker + GIF image send; no JS send owner when native |
