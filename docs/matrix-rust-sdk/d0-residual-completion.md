...
| **V-SEND.3** | Polls                                   | **In flight** [#250](https://github.com/nepenth/synara-desktop/pull/250): native `matrix_send_poll` / `matrix_poll_respond`; JS poll writers deleted from RoomInput/useCommands/PollContent; relation read residual                                                                  | Native                                                  |
