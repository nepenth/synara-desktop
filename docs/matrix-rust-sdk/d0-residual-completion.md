...
| Field                     | Value                                                                                                                                                                     |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Status                    | **Active — tip `d17ab2c` (#249 read); V-ROOMS.5w writers draft; V-SEND.3 #250 / V-TIMELINE #240 parallel** (2026-07-30)                                       |
| Policy                    | [full-vertical-policy.md](full-vertical-policy.md)                                                                                                                        |
| Integration tip at policy | `0400306` (D0.1–D0.5 merged; D0.5 was **crypto minimum**)                                                                                                                 |
| Current integration tip   | `d17ab2c0d72b129189a80d03bd0c1b56d6c230d6` (V-ROOMS.5 read #249 merge)                                                                                                     |
| Active PRs                | Draft V-ROOMS.5 writers; [#250](https://github.com/nepenth/synara-desktop/pull/250) V-SEND.3; [#240](https://github.com/nepenth/synara-desktop/pull/240) V-TIMELINE |
...
| **V-ROOMS.2** | Spaces / hierarchy / lobby           | **2a DONE**; lobby/mutations remain **2b** js                                                                                                                                                             | Native space hierarchy ownership (2a parent map + 2b lobby)                         |
...
| **V-ROOMS.5** | `m.direct` DM room-id map            | **Read DONE #249** at `d17ab2c` (candidate `708aef7`); production **189→187** / **202→200**; live proof Not confirmed                                                                                                                              | Native DM map read+write; JS mDirect owners deleted                                 |
| **V-ROOMS.5w** | `m.direct` DM writers               | **Draft candidate** — native `matrix_mdirect_add` / `matrix_mdirect_remove`; JS helpers deleted; importers **187→187**; `useDirectUsers` reader residual                                                                                           | Native write IPC; JS writer helpers deleted                                         |
...
| ID           | Capability                              | Residual today                                                                                                                                                                                                                                                                         | Done when                                               |
| ------------ | --------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| **V-SEND.1** | Attachments / media upload send         | **DONE #248** at integration `90be0f4ef6efb3915bb886790ebc94e39f088092`; native `matrix_send_attachment` owns composer UploadBoard upload+send; GIF/avatar/call/forward residual remain elsewhere                                                                                      | Native send queue + IPC + JS owner deletion             |
...
| **V-SEND.3** | Polls                                   | Draft [#250](https://github.com/nepenth/synara-desktop/pull/250)                                                                                                                                                                                                                       | Native                                                  |
