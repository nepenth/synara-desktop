...
| Tip SHA | `60141c8b` (current docs/integration tip; post-#458/#461 product state with #450 at `103a653f`, #446 at `9fb341af`, #405 at `176fc7c5`, and #439 at `f92a33f9`) |
...
> slice. This docs-only packet is refreshed at docs tip `60141c8b`; the product
...
> based at `c1e9c3be` and is now rebased onto `60141c8b`; this refresh records the
...
native hook/permission ownership. The current docs/integration tip `60141c8b`
...
| Surface | Current tip (`60141c8b`) | Residual after merged #405/#439/#446/#450; #458/#461 are unrelated |
| ------- | ----------------------------------------------- | ------------------------------------ |
...
| Product changes in this PR                                           | None; this packet is docs-only, refreshed at `60141c8b`, and does not edit product command modules |
...
`useRoomMembers`. At current docs/integration tip `60141c8b`, I confirmed the live native producer in
