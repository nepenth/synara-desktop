...
| Tip SHA | `a9098bd7` (current product/integration tip; post-#458/#461 product state with #450 at `103a653f`, #446 at `9fb341af`, #405 at `176fc7c5`, and #439 at `f92a33f9`) |
...
> slice. This docs-only packet is refreshed against docs head `095dadb9`; the product
...
> base but do not change this residual. The accepted **#482** and **#486**
> refreshes were docs-only and did not change product ownership; the #481–#488
> docs wave is present at this docs head, and this refresh records the current
> product/integration tip honestly. It does not
...
native hook/permission ownership. The current product/integration tip `a9098bd7`
...
| Product changes in this PR                                           | None; this packet is docs-only, refreshed against docs head `095dadb9`, and does not edit product command modules |
...
`useRoomMembers`. At current product/integration tip `a9098bd7`, I confirmed the live native producer in
