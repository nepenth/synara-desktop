...
| Measured tip     | Current integration tip `fd0dfbf464ea59351d2cca1b746ba9d3f00923e7`                 |
...
> `fd0dfbf4`. The first slice lands the native public-room
...
this inventory is refreshed at integration tip `fd0dfbf4`; the checks and route
