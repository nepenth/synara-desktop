...
1. Review and merge the V-CRYPTO.6 automatic UTD/history-recovery wire-plus-delete candidate; live two-client recovery proof remains unconfirmed until the existing harness is run.
...
- V-CRYPTO.6 candidate integrates P5.10/P8.7 into the managed native timeline,
