...
| ---------- | --------------------- | ------------- | ----- |
| current    | **Integration tip**   | **`607dd930`** | #560–#602 merged; every slice independently reviewed + Quality gate + Desktop package gate green; provenance anchor verified after each merge |
