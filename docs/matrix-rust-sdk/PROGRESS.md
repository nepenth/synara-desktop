...
| Integration tip    | `08a185ead8155347475f77ab1d3c42c43a83938c` — V-AUTH.1 [#238](https://github.com/nepenth/synara-desktop/pull/238) merged with required CI green                 |
| Active work        | **V-ROOMS.1 #241, V-SEND.2 #239, and V-TIMELINE #240 are draft candidates.** V-ROOMS/V-SEND were rebased on V-AUTH and required CI is running.                    |
...
| Import accounting  | V-AUTH.1 merged: production **201→197**, repository-wide **215→211**. V-ROOMS.1 candidate: production **197→194**, repository-wide **211→208**. V-SEND.2 candidate: whole importers **197→197**; direct JS reaction owner calls decrease. |
...
|               |                                                                                                                                                                        |
| ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Now**       | **V-AUTH.1 [#238](https://github.com/nepenth/synara-desktop/pull/238) is merged** at `08a185e`: desktop SSO entry/callback/token-completion ownership and native SSO UIAA continuation are gone, with no replacement. V-ROOMS.1/#241 and V-SEND.2/#239 have rebased candidates under required CI; V-TIMELINE/#240 remains unselected and incomplete. **#221 HOLD**. |
...
| **Active PRs** | Draft [#239](https://github.com/nepenth/synara-desktop/pull/239) V-SEND.2 reactions; [#240](https://github.com/nepenth/synara-desktop/pull/240) V-TIMELINE; [#241](https://github.com/nepenth/synara-desktop/pull/241) V-ROOMS.1 invites. |
...
| current    | **V-ROOMS.1 native invites**  | **Draft** [#241](https://github.com/nepenth/synara-desktop/pull/241) | Rebased on V-AUTH; native invite snapshot/classification/actions/avatar candidate measures production importers 197→194 and repository-wide 211→208. Required CI is running. |
| current    | **V-SEND.2 native reactions** | **Draft** [#239](https://github.com/nepenth/synara-desktop/pull/239) | Rebased on V-AUTH; native reaction candidate deletes direct JS reaction owner calls but does not remove complete importer files, so importers remain 197→197. Required CI is running. |
| current    | **V-TIMELINE boundary**       | **Draft** [#240](https://github.com/nepenth/synara-desktop/pull/240) | Native snapshot/delta/open/pagination/read boundary and unselected presenter exist. Retained actions, media, viewport ownership, active selection, JS deletion, and runtime proof remain incomplete. |
