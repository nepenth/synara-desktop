...
| | |
| --- | --- |
| **Now** | **D0 dogfood pivot.** Freeze L1-only PRs. Next: **D0.1 Rust login/session sole owner** (break js auth on this branch). Then D0.2 sync+rooms → D0.3 timeline → D0.4 send. |
