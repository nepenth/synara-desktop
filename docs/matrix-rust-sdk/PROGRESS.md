...
| Integration tip    | `27a854d8` — docs-only #478 scoreboard/progress refresh after the merged #469 R-DEVTOOL and #465 members READ docs refreshes; the full #458/#461 verticals remain WIP |
...
|                |                                                                                                                                                                                                                                        |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Now**        | **Tip `27a854d8`** carries the docs-only #478 scoreboard/progress refresh after the merged #450 power/creator reads, #458 presence first slice, and #461 room-directory first slice; the full #458/#461 verticals remain **WIP**. Custom power-level tags and direct helper/plugin reads remain residual. Imports are **150**; C3–C5 are Not confirmed; V-BURN HOLD; #39 gated. |
| **Tip**        | `27a854d8`                                                                                                                                                                                                                             |
| **Active PRs** | #478 is merged at this integration tip; this focused directory packet refresh is docs-only and does not change product implementation, `main`, or umbrella #39 state. |
