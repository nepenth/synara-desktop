...
| Integration tip    | `8577f0b7` — after #364 leave, #362 CallWidget, #363 composer fallbacks, #365 pack get\* delete                                      |
...
|                |                                                                                                                                                                                                                                        |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Now**        | **Tip `8577f0b7`**. Product idle after finish-line leave (#364). Next: join/create lifecycle or members/power; C3–C5 live session. #39 gated.                                                                                          |
| **Tip**        | `8577f0b7`                                                                                                                                                                                                                             |
...
### 2026-08-01 — tip `8577f0b7` after #365/#363/#362/#364

| When (UTC) | Item                                  | Result          | Notes                                                                                             |
| ---------- | ------------------------------------- | --------------- | ------------------------------------------------------------------------------------------------- |
| current    | **Integration tip**                   | **This PR**     | Tip `8577f0b7` on `feature/matrix-rust-sdk-full-replacement`. Imports/allowlist **155**.          |
