...
| Docs tip   | `095dadb9a6c129a56cedd3e5d4346df4d3d702d4` — docs-only refresh after the #489–#495 wave; no product code changed after the #458 base |
...
> **Post-merge note at implementation base `c1e9c3be`; docs refresh at `095dadb9`.** #458 is merged at the implementation tip.
...
- The complete lifecycle/error matrix and independent acceptance review must be
  retained against the `c1e9c3be` implementation base and this `095dadb9` docs
...
1. `HEAD` is the docs refresh tip `095dadb9a6c129a56cedd3e5d4346df4d3d702d4`,
