...
| Measured tip | `095dadb9` on `feature/matrix-rust-sdk-full-replacement`                                                                           |
...
> CallWidget evidence anchor to `095dadb9`.
...
1. The implementation landed at the approved integration tip now recorded as
   ...
   `095dadb9`. The CallWidget implementation paths are unchanged from the
