...
| Policy        | Clean-break; **no dual-backend**; **[full-vertical-policy.md](full-vertical-policy.md)** — complete replacement only            |
...
Earlier D0 wording allowed a partial crypto path and an “approved residual plateau” burn-down. **User directive cancels that.** Incomplete verticals must be finished to full product parity for retained capabilities before starting new verticals.
...
3. No PR accepted with incomplete/minimum/plateau residual as done
