...
| Rich send, edit, forward    | Typed send/edit/forward DTO commands               | Plain-text edit (`matrix_timeline_edit_text`) and text forward (`matrix_timeline_forward_text`) exist with typed readback; rich/HTML send and media forward remain pending                                                                                                     |
| Redact, report, pin         | Typed room-event action commands                   | `matrix_timeline_redact` exists with typed readback; report/pin remain pending                                                                                                                                                                                                 |
