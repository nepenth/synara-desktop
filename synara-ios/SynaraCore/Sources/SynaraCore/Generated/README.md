...
this target's Swift sources from `crates/synara-core/src/synara_core.udl`, and
creates the colocated XCFramework. P4-1 intentionally does not add an iOS
service adapter or replace `MatrixRustSDK` yet.
