...
```sh
PATH=/Users/nepenthe/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH npx tauri --version
rustup target list --installed
xcodebuild -version
PATH=/Users/nepenthe/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH npx tauri ios --help
```

Init:

```sh
PATH=/Users/nepenthe/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH npx tauri ios init --ci --skip-targets-install
```
...
```sh
PATH=/Users/nepenthe/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH npx tauri ios build --debug --target aarch64-sim --ci
```
