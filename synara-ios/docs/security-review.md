...
- Push: push payload parsing routes only to internal app destinations and badge counts; payloads must stay generic.
...
- Apple Developer organization enrollment, signing, and APNs key handling must be completed outside the repository.
